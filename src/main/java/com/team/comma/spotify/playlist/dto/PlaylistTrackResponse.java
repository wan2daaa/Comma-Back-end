...
public final class PlaylistTrackResponse {
    ...
    private PlaylistTrackResponse(Track track, Boolean trackAlarmFlag,
        List<PlaylistTrackArtistResponse> artists) {
    ...
    public static PlaylistTrackResponse of(Track track, Boolean trackAlarmFlag,
        List<PlaylistTrackArtistResponse> artists) {
